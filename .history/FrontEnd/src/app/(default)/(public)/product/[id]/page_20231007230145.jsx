            ...
            <div class="discounted-content">
              <div class="discounted-items" id="1">
                ...
                <div class="item-content">
                  <div class="item-name"><a href="#">Conan Movie 20</a></div>
              ...
              <div class="discounted-items" id="2">
                ...
                <div class="item-content">
                  <div class="item-name"><a href="#">Công chúa Ori</a></div>
              ...
              <div class="discounted-items" id="3">
                ...
                <div class="item-content">
                  <div class="item-name"><a href="#">One Piece</a></div>
                  <div class="item-price"><span>$49.99</span></div>
                </div>
              </div>
              <div class="discounted-items" id="4">
                ...
                <div class="item-content">
                  <div class="item-name"><a href="#">Naruto</a></div>
                  <div class="item-review">
                    <i class="fa fa-solid fa-star fa-2xl icon-star"></i>
                    <i class="fa fa-solid fa-star fa-2xl icon-star"></i>
                    <i class="fa fa-solid fa-star fa-2xl icon-star"></i>
